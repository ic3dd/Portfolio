...
export const translations: Record<Language, Dict> = {
  pt: {
    ...
    "contact.form.error": "Erro ao enviar. Tenta de novo.",
    "contact.form.errorConfig": "O formulário ainda não está configurado. Usa o email ou o telefone ao lado.",
    "contact.form.errorSend": "O envio falhou. Tenta mais tarde ou contacta-me diretamente.",
  ...
  en: {
    ...
    "contact.form.errorConfig": "The form isn’t configured yet. Please use the email or phone on the right.",
    "contact.form.errorSend": "Sending failed. Try again later or contact me directly.",
